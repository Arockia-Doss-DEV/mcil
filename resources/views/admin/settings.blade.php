                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::open(['url' => '/changePassword', 'class' => '', 'changePassword','id'=>'changepasswordDataForm', 'class'=>'form-horizontal','type'=>'file', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off"]) }}
                                <div class="row">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="kt-widget kt-widget--general-1">
                                                    <div class="kt-media kt-media--lg kt-media--circle">
                                                        <img src="{{ asset('assets/images/icons/google-auth-icon.png') }}"
                                                            alt="google -icon">
                                                    </div>
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        @if ($user['2fa_status'] == 0)
                                                                            ...
                                                                            <button class="btn btn-info button-size" attr-user-id="{{ $user->id }}" attr-user-roleid="{{ $user->role_id }}" attr-user-google2fa_secret="{{ $google2fa_secret }}" attr-user-qr_image="{{ $qr_image }}" id="enable2FADataButton">Enable
                                                                            </button>

                                                                        @else

                                                                            <button class="btn btn-info button-size" attr-user-id="{{ $user->id }}" attr-user-roleid="{{ $user->role_id }}" attr-user-google2fa_secret="{{ $google2fa_secret }}" attr-user-qr_image="{{ $qr_image }}" id="disable2FADataButton">Disable
                                                                            </button>
