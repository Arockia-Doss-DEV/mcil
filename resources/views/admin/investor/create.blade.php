        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3 pb-5">
                <div class="col-lg-12 card-margin">
                    ...
                    {{ Form::open(['url' => '/investor/create', 'files' => true, 'id'=>'registerForm', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomplete'=>"off"]) }}
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    {!! Form::select('is_tester', $ac_type, old('is_tester'), ['class' => 'form-control search-input', 'id' => 'is_tester', 'data-parsley-group'=>"block1", "required"=>"required"]) !!}
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    {!! Form::select('role_id', $member_type, old('role_id'), ['class' => 'form-control search-input', 'id' => 'role_id', 'data-parsley-group'=>"block1", "required"=>"required"]) !!}
                                </div>
                                <div class="col-lg-3 mt-3 individual">
                                    ...
                                    {!! Form::select('salutation', $salutation, old('salutation'), ['class' => 'form-control search-input', 'id' => 'salutation', 'data-parsley-group'=>"block1"]) !!}
                                </div>

                                <div class="col-lg-9 mt-3 individual">
                                    <label>Name (As Per NRIC/Passport) <span class="mandatory">*</span></label>
                                    {!! Form::text('first_name', old('first_name'), ['id' => 'first_name', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", "onkeyup"=>"this.value = this.value.toUpperCase();", 'required' => 'required']) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 company">
                                    ...
                                    {!! Form::select('company_country_corporate', $countries, null, ['id'=>'company_country_corporate', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", "required" => 'required']) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 company">
                                    ...
                                    <div class="input-group">
                                         ...
                                         {!! Form::date('date_corporation', old('date_corporation'), ['placeholder' => 'YYYY-MM-DD','id' => 'date_corporation', 'data-parsley-type' => 'date', 'class'=>'form-control search-input', 'data-date-format' => 'YYYY-MM-DD', 'data-parsley-errors-container'=>"#dateCorporationError", 'data-parsley-group'=>"block1", "required" => 'required']) !!}
                                    </div>
                                ...
                                <div class="col-lg-12 mt-3 company">
                                    ...
                                    {!! Form::select('type_company', $type_company, old('type_company'), ['class' => 'form-control search-input', 'id' => 'type_company', 'data-parsley-group'=>"block1", "required" => 'required']) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 individual">
                                    <label>NRIC / Passport No. <span class="mandatory">*</span></label>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    {!! Form::text('peremail', old('peremail'), ['class'=>'form-control search-input', 'id'=>'peremail', 'data-parsley-group'=>"block1", "required"=>"required", 'data-parsley-checkemailpre', 'data-parsley-checkemailpre-message'=>"Email Address already Exists", 'data-parsley-trigger'=>"focusout"]) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 individual">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::date('dob', old('dob'), ['placeholder' => 'YYYY-MM-DD','id' => 'dob', 'data-parsley-type' => 'date', 'class'=>'form-control search-input', 'data-date-format' => 'YYYY-MM-DD', 'data-parsley-errors-container'=>"#dobError", 'data-parsley-group'=>"block1"]) !!}
                                    </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    {!! Form::select('mobile_prefix', $phone_prefix, null, ['id' => 'mobile_prefix', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", "required"=>"required"]) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 individual">
                                    ...
                                    {!! Form::select('country_residence', $countries, null, ['placeholder' => 'Please select ...', 'class' => 'form-control search-input', 'id'=>'country_residence', "data-parsley-group"=>"block1"]) !!}
                                </div>
                                <div class="col-lg-6 mt-3 individual">
                                    <label>Nationality <span class="mandatory">*</span></label>
                                    {!! Form::select('nationality', $countries, null, ['placeholder' => 'Please select ...', 'class' => 'form-control search-input', 'id'=>'nationality', "data-parsley-group"=>"block1"]) !!}
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    {!! Form::select('country', $countries, null, ['class' => 'form-control search-input', 'id'=>'country', "data-parsley-group"=>"block1", "required"=>"required"]) !!}
                                </div>
                                <div class="col-lg-6 mt-3">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    {!! Form::text('postcode', old('postcode'), ['id' => 'postcode', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", "required"=>"required", "data-parsley-type"=>"digits"]) !!}
                                </div>
                                ...
                                <div class="col-lg-6 mt-3 individual">
                                    ...
                                    {!! Form::select('annual_income', $annual_income, old('annual_income'), ['class' => 'form-control search-input', 'id' => 'annual_income', 'data-parsley-group'=>"block1"]) !!}
                                </div>
                                <div class="col-lg-6 mt-3">
