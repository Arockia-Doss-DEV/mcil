        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3">
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <form method="get" action="{{ url('/agents/active')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a class="table-view-card mr-2" href="{{ route('viewInvestor', ['id' => $user->id, 'pageId' => $pageId, 'pageView' => "AA"]) }}"><img src="{{ asset('assets/images/icons/view-icon.png') }}" title="View" alt="view icon" />
                                                        </a>
                                                        ...
                                                        {{ link_to_route('deactiveAgent', $title = 'De-active', $parameters = ['userId' => $user->id], $attributes = ['escape'=>false, 'class' => "btn btn-warning text-white", 'title'=> 'De-active', 'onclick' => "if (confirm('Are you sure you want to de-active agent?')){return true;}else{event.stopPropagation(); event.preventDefault();};"]); }}
