...
@section('title', 'Investors In-active')
        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3">
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <form method="get" action="{{ url('/investor/inActive')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        @foreach ($users as $key => $user)    
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        <a class="table-view-card mr-2" href="{{ route('viewInvestor', ['id' => $user->id, 'pageId' => $pageId, 'pageView' => "II"]) }}"><img src="{{ asset('assets/images/icons/view-icon.png') }}" title="View" alt="view icon" />
                                                        </a>
