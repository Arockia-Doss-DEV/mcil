        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3 mb-5">
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <form method="get" action="{{ url('/subscription/funding')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="input-group mb-3">
                                            <input type="text" name="q" placeholder="Search By Investment No"
                                    ...
                                    @if ($subscriptions->count() > 0)
                                        ...
                                        @foreach ($subscriptions as $key => $ss)
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-primary mt-2 mr-2">
                                                    <?php 
                                                    if($ss->status == 1){
