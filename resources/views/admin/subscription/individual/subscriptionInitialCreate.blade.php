                ...
                <div class="col-lg-12">
                    <div class="card card-margin">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => ['individualInitialSave',['userId' => $user->id]], 'method' => 'POST', 'id'=>'subscriptionform', 'class' => 'multisteps-form__form', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off",'enctype'=>'multipart/form-data']) }}
...
<script type="text/javascript">  
    ...
    function saveSubscriptionDraft(){
        ...
        if ($('#subscriptionform').parsley().validate('block1')) {
            ...
            axios.post(SITE_URL+'subscription/individualInitialDraft',formData,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'X-CSRF-Token': csrfToken}}
            ).then(function(response){
