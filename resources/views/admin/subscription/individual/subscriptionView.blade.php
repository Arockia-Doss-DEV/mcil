...
@section('title', 'Individual Subscription View ')
...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
                            ...
                            <div class="tab-content" id="nav-tabContent1">
                                <div class="tab-pane fade show active" id="nav-home1" role="tabpanel"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h5 class="font-weight-bold mb-3">Investment Fund :</h5>
                                            </div>
                                            <div>
                                ...
                                <div class="tab-pane fade" id="nav-profile1" role="tabpanel" aria-labelledby="nav-profile-tab1">
                                    <div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-8 col-6"><span class="font-weight-bold">
                                                <?= $subscription->bankac_updated_date == null ? '-' : date('d M, Y', strtotime($subscription->bankac_updated_date)) ?>
                                                </span></div>
                                        </div>

                                        @if(!empty($subscription->bankac_updated_by))
                                        <div class="row mt-3">
                                            <div class="col-lg-3 col-6">
                                                <h6>Updated By</h6>
                                            </div>
                                            <div class="col-lg-8 col-6"><span class="font-weight-bold">
                                                ...
                                                <?= $subscription->has('SubscriptionBankAcUpdatedBy') ? $subscription->SubscriptionBankAcUpdatedBy->first_name .' '. $subscription->SubscriptionBankAcUpdatedBy->last_name : '' ?>
                                                </span></div>
                                        </div>
                                        @endif
                                ...
                                <div class="tab-pane fade" id="nav-contact1" role="tabpanel" aria-labelledby="nav-contact-tab1">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <a type="button" href="javascript:void(0);" class="table-view-card mr-1 get-beneficiary1" get-investment-id='<?= $subscription->id ?>'><i class="fas fa-pencil-alt skyblue-color"></i></a>
                                            </div>

                                            {{-- <?php if($subscription->b1_status == 1){ ?>
                                                <div>
                                        ...
                                        @if(!empty($subscription->b1_updated_by))
                                        <div class="row mt-3">
                                            <div class="col-lg-3 col-6">
                                                <h6>Updated By</h6>
                                            </div>
                                            <div class="col-lg-8 col-6"><span class="font-weight-bold">
                                                ...
                                                <?= $subscription->has('SubscriptionB1UpdatedBy') ? $subscription->SubscriptionB1UpdatedBy->first_name .' '. $subscription->SubscriptionB1UpdatedBy->last_name : '' ?>
                                                </span></div>
                                        </div>
                                        @endif
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <a type="button" href="javascript:void(0);" class="table-view-card mr-1 get-beneficiary2" get-investment-id='<?= $subscription->id ?>'><i class="fas fa-pencil-alt skyblue-color"></i></a>
                                            </div>

                                            {{-- <?php if($subscription->b2_status == 2){ ?>
                                                <div>
                                                    <?php if($subscription->beneficiary_status == 1){ ?>
                                                        <a type="button" href="javascript:void(0);" class="table-view-card mr-1 get-beneficiary2" get-investment-id='<?= $subscription->id ?>'><i class="fas fa-pencil-alt skyblue-color"></i></a>
                                                    <?php } ?>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-8 col-6"><span class="text-muted">
                                                <?= $subscription->b2_updated_date == null ? '-' : date('d M, Y', strtotime($subscription->b2_updated_date)) ?>
                                            </span>
                                            </div>
                                        </div>

                                        @if(!empty($subscription->b2_updated_by))
                                        <div class="row mt-3">
                                            <div class="col-lg-3 col-6">
                                                <h6>Updated By</h6>
                                            </div>
                                            <div class="col-lg-8 col-6"><span class="font-weight-bold">
                                                ...
                                                <?= $subscription->has('SubscriptionB2UpdatedBy') ? $subscription->SubscriptionB2UpdatedBy->first_name .' '. $subscription->SubscriptionB2UpdatedBy->last_name : '' ?>
                                                </span></div>
                                        </div>
                                        @endif
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <a href="{{ asset(Storage::url('')); }}/<?= $subscription->redemption_file ?>"  download class="btn btn-info btn-rounded btn-fw mt-1 mr-1">Invester Redemption Form Download </a>
                                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-3">
                                    <label>Payout Date <span class="mandatory">*</span></label>
                                    <div class="input-group">
                                        <input type="date" class="form-control search-input" name="payout_date" id="edit_payout_date" data-parsley-errors-container="#payout2_dateError" required>
                                    </div>
                                    <div id="payout2_dateError"></div>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {{ Form::open(['url' => '/subscription/view/'.$subscription->id, 'id'=>'formsigedApplication', 'class'=>'', 'files' => true, 'data-parsley-validate', 'autocomplete'=>"off"]) }}
                            ...
                            <div class="modal-body">
                                <?php if($user->individual->nationality == 129): ?>
                                    <div class="col-md-12 mb-3">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 documentModalerr">
                                        ...
                                        <input type="file" name="attachment" data-height="300" data-max-file-size="5M" data-allowed-file-extensions="pdf png jpg jpeg" data-parsley-errors-container="#uploadDoc-errors" data-remove-required="0" class="dropify" id="attachment" required />
                                    </div>
            ...
            <!-- editBeneficiaryModel info Modal -->
            <div class="modal fade" id="editBeneficiaryModel" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Beneficiary details update</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>

                        {{ Form::open(['url' => '/subscription/view/'.$subscription->id, 'id'=>'form-beneficiary-edit', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off"]) }}
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        {!! Form::text('b1_name', $subscription->b1_name, ['id' => 'b1_name', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Country / Region of Residence *</label>
                                        {!! Form::select('b1_residence_id', $countries, $subscription->b1_residence_id,['class' => 'form-control fund-sub-input', 'id' => 'b1_residence_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Nationality *</label>
                                        {!! Form::select('b1_nationality_id', $countries, $subscription->b1_nationality_id,['class' => 'form-control fund-sub-input', 'id' => 'b1_nationality_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label id="beneficiares1_passport_label">NRIC / Passport No. *</label>
                                        {!! Form::text('b1_nric_passport', $subscription->b1_nric_passport, ['id' => 'b1_nric_passport', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Date of Birth *</label>
                                        <div class="input-group">
                                            {!! Form::date('b1_dob', $subscription->b1_dob, ['class'=>'form-control search-input', 'id' => 'b1_dob', 'data-parsley-group'=>"block1", 'data-parsley-errors-container'=>"#b1_dob_error", 'required' => 'required']) !!}
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        {!! Form::text('b1_occupation', $subscription->b1_occupation, ['id' => 'b1_occupation', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>


                                    <div class="col-lg-12 mt-3">
                                        <label>Address *</label>
                                        {!! Form::text('b1_address_line_1', $subscription->b1_address_line_1, ['id' => 'b1_address_line_1', 'class'=>'form-control search-input', "placeholder"=>"Address Line 1", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-12 mt-3">
                                        {!! Form::text('b1_address_line_2', $subscription->b1_address_line_2, ['id' => 'b1_address_line_2', 'class'=>'form-control search-input', "placeholder"=>"Address Line 2", 'data-parsley-group'=>"block1"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>City *</label>
                                        {!! Form::text('b1_city', $subscription->b1_city, ['id' => 'b1_city', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Country / Region *</label>
                                        {!! Form::select('b1_country_id', $countries, $subscription->b1_country_id,['class' => 'form-control fund-sub-input', 'id' => 'b1_country_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Postcode *</label>
                                        {!! Form::text('b1_postcode', $subscription->b1_postcode, ['id' => 'b1_postcode', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required', "data-parsley-type"=>"digits"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>State *</label>

                                        <select class="form-control search-input" name="b1_state_id" id="b1_state_id" data-parsley-group="block1" required>
                                            <option value="">--</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        {!! Form::select('b1_mobile_prefix', $phone_prefix, $subscription->b1_mobile_prefix,['class' => 'form-control fund-sub-input', 'id' => 'b1_mobile_prefix', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Mobile No *</label>
                                        {!! Form::text('b1_mobile_number', $subscription->b1_mobile_number, ['id' => 'b1_mobile_number', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required', "data-parsley-type"=>"digits"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Email *</label>
                                        {!! Form::email('b1_email', $subscription->b1_email, ['id' => 'b1_email', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Relationship to applicant *</label>
                                        {!! Form::text('b1_relationship', $subscription->b1_relationship, ['id' => 'b1_relationship', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
            ...
            <!-- editBeneficiaryModel 2 info Modal -->
            <div class="modal fade" id="editBeneficiary2Model" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        {{ Form::open(['url' => '/subscription/view/'.$subscription->id, 'id'=>'form-beneficiary2-edit', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off"]) }}
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <label>Name (as per NRIC/Passport) *</label>
                                        {!! Form::text('b2_name', $subscription->b2_name, ['id' => 'b2_name', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Country / Region of Residence *</label>
                                        {!! Form::select('b2_residence_id', $countries, $subscription->b2_residence_id,['class' => 'form-control fund-sub-input', 'id' => 'b2_residence_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Nationality *</label>
                                        {!! Form::select('b2_nationality_id', $countries, $subscription->b2_nationality_id,['class' => 'form-control fund-sub-input', 'id' => 'b2_nationality_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label id="beneficiares1_passport_label">NRIC / Passport No. *</label>
                                        {!! Form::text('b2_nric_passport', $subscription->b2_nric_passport, ['id' => 'b2_nric_passport', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Date of Birth *</label>
                                        <div class="input-group">
                                            {!! Form::date('b2_dob', $subscription->b2_dob, ['class'=>'form-control search-input', 'id' => 'b2_dob', 'data-parsley-group'=>"block1", 'data-parsley-errors-container'=>"#b2_dob_error", 'required' => 'required']) !!}
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <label>Occupation *</label>
                                        {!! Form::text('b2_occupation', $subscription->b2_occupation, ['id' => 'b2_occupation', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>


                                    <div class="col-lg-12 mt-3">
                                        <label>Address *</label>
                                        {!! Form::text('b2_address_line_1', $subscription->b2_address_line_1, ['id' => 'b2_address_line_1', 'class'=>'form-control search-input', "placeholder"=>"Address Line 1", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-12 mt-3">
                                        {!! Form::text('b2_address_line_2', $subscription->b2_address_line_2, ['id' => 'b2_address_line_2', 'class'=>'form-control search-input', "placeholder"=>"Address Line 2", 'data-parsley-group'=>"block1"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>City *</label>
                                        {!! Form::text('b2_city', $subscription->b2_city, ['id' => 'b2_city', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Country / Region *</label>
                                        {!! Form::select('b2_country_id', $countries, $subscription->b2_country_id,['class' => 'form-control fund-sub-input', 'id' => 'b2_country_id', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Postcode *</label>
                                        {!! Form::text('b2_postcode', $subscription->b2_postcode, ['id' => 'b2_postcode', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required', "data-parsley-type"=>"digits"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>State *</label>

                                        <select class="form-control search-input" name="b2_state_id" id="b2_state_id" data-parsley-group="block1" required>
                                            <option value="">--</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <label>Mobile No Prefix *</label>
                                        {!! Form::select('b2_mobile_prefix', $phone_prefix, $subscription->b2_mobile_prefix,['class' => 'form-control fund-sub-input', 'id' => 'b2_mobile_prefix', "placeholder"=>"--SELECT--", 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Mobile No *</label>
                                        {!! Form::text('b2_mobile_number', $subscription->b2_mobile_number, ['id' => 'b2_mobile_number', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required', "data-parsley-type"=>"digits"]) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Email *</label>
                                        {!! Form::email('b2_email', $subscription->b2_email, ['id' => 'b2_email', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>

                                    <div class="col-lg-6 mt-3">
                                        <label>Relationship to applicant *</label>
                                        {!! Form::text('b2_relationship', $subscription->b2_relationship, ['id' => 'b2_relationship', 'class'=>'form-control search-input', 'data-parsley-group'=>"block1", 'required' => 'required']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script type="text/javascript">
                ...
                if($("#form_status").val() == 1 || $("#form_status").val() == 3){
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            // Swal.fire("Mail confirm: "+`${result.value.mailConfirm}`);
        ...
        $(document).on("click",".get-edit-CIdata",function() {
            ...
            axios.get(SITE_URL+'subscription/ajaxCiGet?id='+we_id).then(function (response) {
                ...
                $('#reference_no').val(item.referenceId);
        ...
        //edit benificiary 1
        $(document).on("click",".get-beneficiary1",function() {
            $('#editBeneficiaryModel').modal('show');
        });

        //edit benificiary 2
        $(document).on("click",".get-beneficiary2",function() {
            $('#editBeneficiary2Model').modal('show');
        });

        $('#form-beneficiary-edit').submit(function(e) {
            e.preventDefault();
            if ( $(this).parsley().isValid() ) {
                ...
                const form = document.getElementById('form-beneficiary-edit');
                let formData = new FormData(form);
    
                formData.set('id', {{ $subscription->id }});
    
                axios.post(SITE_URL+'subscription/ajaxBeneficiaryEditSave',formData,{
                        headers: {
                            'Content-Type': 'multipart/form-data',
                            'X-CSRF-Token': csrfToken}}
                ).then(function(response){
                    ...
                    if(item != "null"){
                        ...
                        Swal.fire('Great Job !','Beneficiary details updated successfully!','success');
                        $('#editBeneficiaryModel').modal('hide');
                        setTimeout(location.reload.bind(location), 1500);
                    }else{
                        Swal.fire('Sorry !','Beneficiary details update faild!','error');
                    } 
                })
                .catch(function(){
                    Swal.fire('Sorry !','Beneficiary details update faild!','error');
        ...
        $('#form-beneficiary2-edit').submit(function(e) {
            e.preventDefault();
            if ( $(this).parsley().isValid() ) {
                ...
                const form = document.getElementById('form-beneficiary2-edit');
                let formData = new FormData(form);
