        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3 mb-5">
                <div class="col-lg-12 card-margin">
                    <div class="card">
                        <div class="card-body">
                            <form method="get" action="{{ url('/subscription/jointAccounts')}}">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    @if ($subscriptions->count() > 0)
                                        ...
                                        @foreach ($subscriptions as $key => $ss)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <a class="table-view-card" href="{{ url('/subscription/view/'.$ss->id) }}"><img src="{{ asset('assets/images/icons/view-icon.png') }}"
                                                        alt="view icon" /></a> --}}
                                                    <?php
                                                        if(isset($_GET['page'])) {
                                                            $pageId=$_GET['page'];
