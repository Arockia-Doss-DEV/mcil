...
@section('title', 'Edit Additional Investment')
                        ...
                        <div class="card-header">
                            <h5 class="card-title">
                                <img src="{{ asset('assets/images/icons/pencil-icon.png') }}"
                                    alt="edit-icon" class="mr-2" />Edit Additional Investment</h5>
                        </div>
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => ['individualSubscriptionUpdate',['userId' => $user->id, 'subId' => $subscription->id]], 'method' => 'POST', 'id'=>'subscriptionform', 'class' => 'multisteps-form__form', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off",'enctype'=>'multipart/form-data']) }}
                                ...
                                <div class="multisteps-form__panel  p-4 rounded bg-white js-active" data-animation="scaleIn">
                                    @include("admin.subscriptionElements.individual.additionalScription")
                                </div>

                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("admin.subscriptionElements.individual.additionalDeclaration")
                                </div>

                                <!--single form panel-->
                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("admin.subscriptionElements.individual.additionalDocuments")
                                </div>
                                
                                <!--single form panel-->
                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("admin.subscriptionElements.individual.additionalReviews")
                                </div>
...
<script type="text/javascript">  
    ...
    function saveSubscriptionDraft(){
        ...
        if ($('#subscriptionform').parsley().validate('block1')) {
            ...
            axios.post(SITE_URL+'subscription/individualAdditionalDraft',formData,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'X-CSRF-Token': csrfToken}}
            ).then(function(response){
