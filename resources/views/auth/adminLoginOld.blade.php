                            ...
                            <div class="text-center my-4">
                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col-12 col-lg-6 m-auto">
                                        <input type="text" class="form-control fund-sub-input @error('gotp') is-invalid @enderror" placeholder="Enter OTP" name="gotp" value="{{ old('gotp') }}" id='users-gotp' required="required" data-parsley-type="digits" maxlength="6" data-parsley-group="group-3" pattern="\d{6}" data-parsley-errors-container="#users_otp-errors" style="text-align:center;" />
                                    </div>
                            ...
                            <div class="text-center my-4">
                               ...
                               {{--  <div id="otp" class="otp-digit my-4">
                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col-12 col-lg-6 m-auto">
                                        <input type="text" class="form-control fund-sub-input @error('otp') is-invalid @enderror" placeholder="Enter OTP" name="otp" value="{{ old('otp') }}" id='users-otp' required="required" data-parsley-type="digits" maxlength="6" data-parsley-group="group-2" pattern="\d{6}" data-parsley-errors-container="#users_otp-errors" style="text-align:center;"/>
                                    </div>
