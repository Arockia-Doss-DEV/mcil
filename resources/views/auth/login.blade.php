                    ...
                    <div id="pills-tab" role="tablist">
                        <div class="tab-content login_box" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-profile" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input email required">
                                        <input type="email" name="email" class="form-control bx_shodow @error('email') is-invalid @enderror" value="{{ old('email') }}" required="required" id="email" placeholder="Enter Username (输入用户名)" data-parsley-required="data-parsley-required" autocomplete="email" autofocus data-parsley-group="group-1" maxlength="100"/>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="pills-gotp" href="#pills-gotp" role="tabpanel">
                                ...
                                {{-- <button type="button" id="gverifyOTP" class="btn btn-block login-btn">Verify (确认)</button> --}}
                            ...
                            <div class="tab-pane fade" id="pills-otp" href="#pills-otp" role="tabpanel">
                                ...
                                {{-- <button type="button" id="verifyOTP" class="btn btn-block login-btn">Verify (确认)</button> --}}
