                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                        	...
                        	{{ Form::open(['url' => '/company/changePassword', 'class' => '', 'changePassword','id'=>'changepasswordDataForm', 'class'=>'form-horizontal','type'=>'file', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off"]) }}
	                            <div class="row">
            ...
            <div class="modal fade" id="enable2FADataModel" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        {{ Form::open(['url' => '/company/gauthEnable', 'id'=>'enable2FADataForm', 'data-parsley-validate'=>'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off"]) }}
...
<script type="text/javascript">
    ...
    $('#enable2FADataForm').submit(function(e) {
        ...
        if ( $(this).parsley().isValid() ) {
            ...
            axios.post(SITE_URL+'company/gauthEnable',formData,{
                    headers: {
    ...
    $(document).on("click","#disable2FADataButton",function() {
        Swal.fire({
            ...
            if (result.value) {
                ...
                axios.post(SITE_URL+'company/gauthDisable',formData,{
                        headers: {
                            'Content-Type': 'multipart/form-data',
                            'X-CSRF-Token': csrfToken}}
                ).then(function (response) {
