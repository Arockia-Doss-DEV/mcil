                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex widget-20-post-info">
                                                        ...
                                                        <span class="d-flex flex-column mt-3">
                                                            <h4 class="author-name">{{ $user->last_name }}</h4>
                                                            <span class="time">Company</span>
                                                            <span class="badge badge-pill badge-vilet mt-2 mr-2">Company/Club/Society/Partnership</span>
                                                        </span>
                                        ...
                                        <div class="row my-3">
                                            <div class="col-lg-6">
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-lg-8 col-6"><span class="text-muted">{{ $user->last_name }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-lg-4 col-6">
                                                    ...
                                                    <div class="col-lg-8 col-6"><span
                                                            class="text-muted">{{ $user->company->company_reg_no }}</span></div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-lg-4 col-6">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-lg-8 col-6"><span class="text-muted">
                                                        <?= $user->company->business_activity ?>
                                                    </span></div>
                                                </div>
