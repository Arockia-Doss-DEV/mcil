                ...
                <div class="col-lg-12">
                    <div class="card card-margin">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => ['subscriptionCompanyAdditionalSave',['userId' => $user->id, 'subId' => $subscription->id]], 'method' => 'POST', 'id'=>'subscriptionform', 'class' => 'multisteps-form__form', 'data-parsley-validate'=>'data-parsley-validate', 'autocomplete'=>"off",'enctype'=>'multipart/form-data']) }}
                                ...
                                <div class="multisteps-form__panel  p-4 rounded bg-white js-active" data-animation="scaleIn">
                                    @include("elements.company.additionalSubscription")
                                </div>

                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("elements.company.additionalDeclaration")
                                </div>

                                <!--single form panel-->
                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("elements.company.additionalDocuments")
                                </div>
                                
                                <!--single form panel-->
                                <div class="multisteps-form__panel  p-4 rounded bg-white" data-animation="scaleIn">
                                    @include("elements.company.additionalReviews")
                                </div>
...
<script type="text/javascript">  
    ...
    function saveSubscriptionDraft(){
        ...
        if ($('#subscriptionform').parsley().validate('block1')) {
            ...
            axios.post(SITE_URL+'company/additionalDraft',formData,{
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'X-CSRF-Token': csrfToken}}
            ).then(function(response){
