...
<table id="example" class="table table-striped table-bordered">
    ...
    @if ($subscriptions->count() > 0)
        ...
        <tr>
            ...
            <td class="text-muted">{{ $investment_type }}</td>
            ...
            {{-- @if ($subscription->Payments->count() > 0)
                <td class="text-muted">{{ $subscription['payments'][$key]['percentage'] }}</td>
                <td class="text-muted">{{ $subscription['payments'][$key]['amount'] }}</td>
            @else
                <td class="text-muted">{{ $divident_percentage }}</td>
                <td class="text-muted">{{ $divident_amount }}</td>
            @endif --}}

            <td class="text-muted">{{ $bank_name }}</td>
            <td class="text-muted">{{ $account_name }}</td>
            <td class="text-muted">{{ $account_number }}</td>
            <td class="text-muted">{{ $swift_code }}</td>
            <td class="text-muted">{{ $total_divident_amount }}</td>
            <td class="text-muted">{{ $original_investment_no }}</td>
