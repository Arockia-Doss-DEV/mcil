                            ...
                            <div class="row">
                                ...
                                @if (!empty($enable_subscription))
                                    <div class="col-lg-8 text-md-right">
                                        <a class="btn btn-info mr-1" href="{{ url('/individual/additionalCreate') }}"> + Additional Investment</a>
                                    </div>
                                @endif
                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="font-weight-bold">#
                                                            ...
                                                            <?php 
                                                                ...
                                                                echo link_to(url('/individual/view/subscription/'.$ss->id), $title = $investment_no, $attributes = [], $secure = null);  
                                                            ?>
                                                        ...
                                                        <td><a class="table-view-card" href="{{ url('/individual/view/subscription/'.$ss->id) }}">
                                        ...
                                        <table id="example" class="table table-striped table-bordered">
                                            ...
                                            @if ($subscriptionsDraft->count() > 0)    
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a class="table-view-card mr-1" href="{{ url('/individual/subscriptionEdit/'.$ss->id) }}">
                                                            <img src="{{ asset('assets/images/icons/edit-icon.png') }}"
                                                                alt="view icon" />
                                                        </a>

                                                        <form action="{{ route('individualSubscriptionDelete', $ss->id)}}" method="post">
                                                            @method('DELETE')
                                                            @csrf
