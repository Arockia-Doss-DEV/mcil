...
@if (Request::path() == 'individual/dashboard' or Request::path() == 'individual/documentBankIndex' or request()->is('individual/view/subscription/*'))
        ...
        function wireUpEvents() {
            window.addEventListener("beforeunload", function (e) { 
                ...
                if (!validNavigation) {
                    ...
                    axios.post(SITE_URL+'sessionLogout',fd,{
                        headers: {
