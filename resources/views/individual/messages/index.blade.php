                                            ...
                                            <div class="widget-22">
                                                ...
                                                <div class="widget-22-body">
                                                    <div class="widget-22-post-container">
                                                        <a href="{{ url('/individual/newsletter/view',$email->id) }}" class="title text-center"><?php echo substr($email->UserEmails->subject,0, 30)."..." ?></a>
                                                        <div class="desc"><?php echo strip_tags(substr($email->UserEmails->message,0, 180)."...") ?> </div>
                                                        <div>
                                                            <div class="my-4">
                                                                <a href="{{ url('/individual/newsletter/view',$email->id) }}" class="btn btn-info w-100">View More</a>
                                                            </div>
                                                            <div class="my-3">
