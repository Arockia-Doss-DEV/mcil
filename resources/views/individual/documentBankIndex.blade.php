                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb no-bg custom-breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/individual/myprofile') }}">Profile</a></li>
            ...
            <div class="modal fade" id="uploadFileModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {{ Form::open(['url' => '/individual/documentBankIndex', 'id'=>'formupdatepassport', 'files' => true, 'data-parsley-validate', 'autocomplete'=>"off"]) }}
...
<script type="text/javascript">
    ...
    $('#formupdatepassport').submit(function(e) {
        ...
        if ( $(this).parsley().isValid() ) {
            ...
            axios.post(SITE_URL+'individual/documentBankUpload',formData,{
                    headers: {
    ...
    $('.reviewDoc').on('click', function () {
        ...
        axios.get(SITE_URL+'individual/bankDocReview?id='+id).then(function (response) {
