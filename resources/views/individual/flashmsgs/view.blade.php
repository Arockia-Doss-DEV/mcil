    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="d-flex justify-content-between">
                ...
                <div class="go-back"><a href="{{ url('/individual/fmsgIndex') }}"><img
                        ...
                        <div class="card-body news-details-card-body">
                            <div class="widget-20">
                                ...
                                <div class="widget-20-body">
                                    <img src="{{ $fmsg->file ? asset('/project_img/flashmsgs/images/'.$fmsg->file) : asset('assets/images/avatars/default.png') }}" alt="Flash Image"
