                                                            ...
                                                            <div class="widget-20">
                                                                    ...
                                                                    <div class="dropdown widget-20-post-action">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-right" >
                                                                            ...
                                                                            <li class="dropdown-item">
                                                                                <a href="{{ url('/individual/fmsgView',$msg->id) }}" class="dropdown-link" title="View"><i
                                                                ...
                                                                <div class="widget-20-body">
                                                                    ...
                                                                    <div class="widget-20-post-container">
                                                                        <a href="{{ url('/individual/fmsgView',$msg->id) }}" class="text-center title">{{ substr($msg->title,0, 30)."..." }}</a>
                                                                        <div class="desc">
                                                                        ...
                                                                        <div>
                                                                            <div class="my-4">
                                                                                <a href="{{ url('/individual/fmsgView',$msg->id) }}"
