                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::date('b1_dob', $edit ? $subscription->b1_dob : old('b1_dob'), ['class'=>'form-control search-input', 'id' => 'b1_dob', 'data-parsley-group'=>"block1", 'data-parsley-trigger' => "change", 'data-parsley-errors-container'=>"#b1_dob_error", 'required' => 'required']) !!}
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::date('ja_dob', $edit ? $subscription->ja_dob : old('ja_dob'), ['class'=>'form-control search-input', 'id' => 'ja_dob', 'data-parsley-group'=>"block1", 'data-parsley-errors-container'=>"#ja_dob_error"]) !!}
                                        </div>
