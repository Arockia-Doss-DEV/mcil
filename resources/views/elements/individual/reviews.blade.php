<div class="multisteps-form__content">
    <div class="row">
        ...
        {{-- @if(@$userData->individual->nationality !== 129) --}}
        ...
        <div class="col-lg-12 mt-3">
            <div class="my-2 string-check string-check-soft-info">
                ...
                <?php
                    ...
                    if(!empty($subscription['is_joint_applicant'])){
                ...
                <label class="string-check-label">
                    <span class="ml-2">{{ $joint_applicant_name != "" ? "We " : 'I ' }} {{ $name }} {{ $joint_applicant_name != "" ? ', '.$joint_applicant_name : '' }} hereby declare, accept and acknowledge the information provided is true and accurate.</span>
                </label>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="text-center mt-4">
                ...
                @else
                    ...
                    <h6 class="mt-3">{{ Auth()->user()->first_name . Auth()->user()->last_name }} 's OTP has been sent to SMS + {{ $mobile_prefix }} {{ $userData['mobile_no'] }}</h6>
                    <div class="row mt-4">
                        <div class="col-12 col-lg-4 m-auto pb-4">
                            {!! Form::text('otp', null, ['id'=> "users-otp", 'class'=>'form-control fund-sub-input', "required"=>"required", "data-parsley-group"=>"block4", "data-parsley-type"=>"digits", "maxlength"=>"6", "pattern"=>"\d{6}"]) !!}
                        </div>
                    </div>
