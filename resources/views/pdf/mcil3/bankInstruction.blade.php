    ...
    <div class="main_div">
        ...
        <table width="100%" class="bankdetails" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="60%"><p>MCIL INTL SERIES 3 LTD</p></td>
            </tr>
            <tr>
                <td><p>Recipient&rsquo;s Account Number :</p></td>
                <td><p>80-1084624-1-40</p></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <p>Unit 3A-2, Level 3A, Labuan Times Square, Jalan Merdeka, 87000 F.T Labuan, Malaysia.</p>
                </td>
            </tr>
            <tr>
                <td><p>Beneficiary Bank :</p></td>
                <td><p>CIMB BANK BHD</p></td>
            </tr>

            <tr>
                <td><p>Beneficiary Bank&rsquo;s SWIFT Code :</p></td>
                    <td><p>CIBBMYKLXXX</p></td>
            </tr>
            <tr>
                <td><p>Beneficiary Bank&rsquo;s Address :</p></td>
                <td><p>Wisma Genting, 28, Jalan Sultan Ismail, 50450 Kuala Lumpur, W.P. Malaysia.</p></td>
            </tr>
            <tr>
