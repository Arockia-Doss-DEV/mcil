    ...
    <div class="main_div">
        <table width="100%">
            <tr>
                ...
                <td align="left">
                    <h1><strong>MCIL INTL SERIES 3 LTD (Company No. LL17539)</strong></h1>
        ...
        <table width="100%">
            ...
            <tr>
                <td><h4>NAME</h4></td> 
                <td colspan="2"><h4><?= $user->last_name ?></h4>
                </td>
            </tr>
            <tr>
                <td><h4>ADDRESS</h4></td>
        ...
        <br>
        <h4><u><strong>Declaration of Dividend Distribution for MCIL INTL Series 3 Ltd (“the Fund”)</strong></u></h4>

        <p>Greetings from MCIL Intl Series 3 Ltd!</p>

        <p>Thank you for investing in MCIL Intl Series 3 Ltd (“the Fund”). We are pleased to announce the Fund’s dividend distribution declaration as follows:</p>
