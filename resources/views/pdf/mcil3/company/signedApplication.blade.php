...
<body>
    ...
    <table>
        <tbody align="center">
            ...
            <tr><td><p style="font-size: 30px;">MCIL INTL SERIES 3 LTD</p></td></tr>
            <tr><td><p style="font-size: 20px;">(Company No. LL17539)</p></td></tr>
        ...
        <tr>
            ...
            <td>
                <?php
                    ...
                    echo '<p style="font-size:17px;">Mirac Financial Ltd.<br>
                        Fund Manager of MCIL INTL Series 3 Ltd<br>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <ol>
                        <li>Minimum initial investment amount shall be USD 125,000.00 or any amount equal or more than Ringgit Malaysia Five Hundred Fifty Thousand (RM500,000) (首次投资，最低金额为125,000.00美元 或任何等于或超过马币二十五万令吉(RM500,000)。)</li>
                        <li>Applicant must be 21 years old and above. (Joint applicant must be 18 years old and above) (申请者必须年满21岁。（联合申请人必须年满 18岁）)</li>
                    ...
                    <ol start="5">
                        <li>Unless otherwise instructed / informed by the company, all cheques, bank drafts or cashiers/money orders must be made payable to "<b>MCIL INTL SERIES 3 LTD</b>" and crossed "<b>ACCOUNT PAYEE ONLY</b>". Please write your name/company's name, NRIC/Passport number/Certificate of Incorporation number on the back of all cheques, bank drafts or cashier's orders/ money orders.<br>(除非公司另有指示/通知,支票、银行汇票或银行本票抬头请写“<b>MCIL INTL SERIES 3 LTD</b>”, 并且在支票左上角画两条平行线，写上“<b>ACCOUNT PAYEE ONLY</b>”只限存入抬头人账户）。请在支票、银行汇票或银行本票背面注明你的姓名或公司名称；身份证号码或护照号码或公司成立登记证号码。</li>
                ...
                <td>
                    ...
                    <ul>
                        ...
                        <li><p>Please e-mail the form to us at admin@mcilintl.com or post it tous at: <b>MCIL INTL SERIES 3 LTD</b>, Address: <?php if($subscription->old_address == 1){ echo 'Unit Level 9F(2), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 W.P. Labuan, Malaysia.'; }else{ echo 'Unit Level 14(B) &amp; 14(C), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 F.T. Labuan, Malaysia</p>'; } ?>.<br>(请通过电子邮件将申请书发送至 admin@mcilintl.com 或将申请书邮寄至： F.T.Labuan, Malaysia.) <b>MCIL INTL SERIES 3 LTD</b>，地址：<?php if($subscription->old_address == 1){ echo 'Unit Level 9F(2), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 W.P. Labuan, Malaysia.'; }else{ echo 'Unit Level 14(B) &amp; 14(C), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 F.T. Labuan, Malaysia</p>'; } ?></p></li>
                    </ul>
                    <p style="font-size: 17px; font-weight: bold;">Share/Unit Certificate (股份证书)</p>
                    <ol start=7>
                        <li><p>Investments in the share/unit of The Fund managed by the Board of Directors are script-less, that is, no share/unit certificate(s) will beissued. Only Acknowledgment / Receipt(s) will be issued to investors as confirmation of their investment. (由董事会负责管理的本基金不 发股票给投资者，仅发出确认通知或收据予投资者作为投资的确 认。)</p>
                    </ol>
                    <p style="font-size: 17px; font-weight: bold;">Rights of MCIL Fund Board of Directors (MCIL 基金董事会的权利)</p>

                    <ol start=8>
                        <li>The Board of Directors reserve the right to accept or reject any application in whole or in part there of with out assigning reasons inrespect thereof.(董事会保留接受或拒绝任何申请认购的权利，无论是全部或一部分，而且无需提供任何理由。)</li>
                        ...
                        <li>Investor(s) hereby note and acknowledge that they may have provided and may provide personal information ("Data") to the Board of Directors and / or any of its agents. Investors areresponsible to notify the Board of Directors in writing within one (l)calendar month of any change to the Data. Investor(s) hereby agreeand acknowledge that the Data and investment data may be used or processed by the Board of Directors and / or its agents with in or outside Malaysia for the purpose of the provision of any services related to The Fund and / or investor's investments.(投资者了解并确认，本身可能已经提供，和将来有 可能会提供其个人信息（以下简称“资料”）予董事会和/或它所 委任的任何代理人。若有关资料有任何变更，投资者有责任在壹 （1）个月内发出书面通知予董事会。投资者特此同意并确认， 董事会和/或其代理人可在马来西亚境内外使用或处理上述资料 和投资资料，作为提供与MCIL 基金和/或投资相关的任何服务 之用途。</li>
                    </ol>
                </td>
            </tr>
        </tbody>
    ...
    <table class="page3" border="1px;" width="100%">
        <tr>
            ...
            <td align="center"><p><br/>(Must be the name of the Principal Applicant - 必须是申请者的姓名)</p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="center"><p></p>
                ...
                <span>(&nbsp;) Current (来往账户) (&nbsp;&nbsp;) Savings (储蓄账户)</span>
            </td>
        </tr>
        <tr>
    ...
    <table class="page3" border="1px;" width="100%">
        <tr>
            <td width="50%">Amount(USD)金额(美元):</td>
            <td width="25%">[&nbsp;]Initial Investment<br/>(首次投资)</td>
            <td width="25%">[&nbsp;]Additional Investment<br/>(附加投资)</td>
        </tr>
        <tr>
            <td width="50%">Processing Fee (汇款/支票号码):</td>
            <td width="50%" colspan="2">Remitting/Issuing Bank(汇款/开证银行): </td>
        </tr>
        <tr>
            <td>Subscription Fee (%) (费用-%): </td>
            <td colspan="2">Total Amount (USD) (金额-美元):></td>
        </tr>
    </table>
    ...
    <table  width="100%">
        <tr>
            <td colspan="3" class="font-18">In the event of my death, I designate the following as my BENEFICIARY 1 for __% and BENEFICIARY 2 for __%. All amount Capital Sum including dividend / interest that may be payable after my death:</td>
        </tr>
        <tr>
            <td colspan="3">
                &#40; 一旦本人逝世,本人指定以下人士为本人的第一受益人,能继承全额资本总额的 __ %,以及第二受益人, &lt; 能继承全额资本总额的 __%。在本人逝世后,包括股息或利息在内的全额资本总额应支付予: &#41;</td>
        </tr>
    </table>
    <br>


    <h3>BENEFICIARY 1 (第二受益人)</h3>
    ...
    <table  class="page4" border="1px;" width="100%">
        <tr>
            ...
            <td><br>
                (Must be the name of the Beneficiary 1 -必须是第贰受益人的姓名)
            </td>
        </tr>
    </table>
    <table width="100%">
    ...
    <table width="100%" class="table page-5 font-18 l-s"  >
        ...
        <table width="100%" class="fo-rm page-5 font-18 l-s"  >
            ...
            <tr>
                <td>Principal Applicant (申请者)</td>
                <td>Joint Applicant (if applicable) (联合申请者 (如果适用)</td>
            </tr>
            <tr>
                <td>Name(姓名): </td>
                <td>Name(姓名): </td>
    ...
    <table width="100%" class="page6" border="1px">
        ...
        <tr>
            ...
            <td><?= $subscription->has('company') ? $subscription->company->company_reg_no : '' ?></td>
        </tr>
        <tr>
            <td class="cl-35">Country of Incorporation (注册国家)</td>
            <td><?= $subscription->has('company') ? $subscription->company->CompanyCountryCorporate->name : '' ?></td>
        </tr>
        <tr>
            <td class="cl-35">Date of Incorporation (公司成立日期)-<br/>DD/MM/YYYY</td>
            <td><?= $subscription->has('company') ? date('d-m-Y', strtotime($subscription->company->date_corporation)) : '' ?></td>
        </tr>
        <tr>
            <td class="cl-35">Principal Business Activity (主要业务活动)</td>
            <td><?= $subscription->has('company') ? $subscription->company->business_activity : '' ?></td>
        </tr>
    </table>

    <h3>Type of Company -公司类型 (√)</h3>
    <?php 
            if(!empty($subscription->company->type_company)){
                $type_company = $subscription->company->type_company;
                $type_company_val = 0;
                switch ($type_company) {
                    case "1":
                        $type_company_val = 1;
    ...
    <table width="100%" class="page6" border="1px">
        <tr>
            <td><?php if($type_company_val == 1){ echo "√";}; ?></td>
            <td class="cl-30">Sole Proprietor (独资企业)</td>

            <td><?php if($type_company_val == 2){ echo "√";}; ?></td>
            <td class="cl-30">Private Limited (私人有限公司)</td>

            <td><?php if($type_company_val == 3){ echo "√";}; ?></td>
            <td class="cl-30">Public Limited (公众有限公司)</td>
        </tr>
        <tr>
            <td><?php if($type_company_val == 4){ echo "√";}; ?></td>
            <td class="cl-30">Partnership (合伙企业)</td>

            <td><?php if($type_company_val == 5){ echo "√";}; ?></td>
            <td class="cl-30">Organization/Foundation/Trust (组织/基金会/信托)</td>

            <td><?php if($type_company_val == 0){ echo "√";}; ?></td>
    ...
    <table width="100%" class="page6" border="1px">
        <tr>
            ...
            <td><?= $subscription->payee_name ?> <br>(Must be the name of the Principal Applicant - 必须是申请者的姓名)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><p><?= $subscription->address_line_1 ?>,
                    ...
                    <?= $subscription->country_id ? $subscription->SubscriptionCountry->name : '' ?>.</td>
        </tr>
        <tr>
    ...
    <table width="100%" class="page6" border="1px">
        ...
        <tr>
            <td class="cl-35">Amount(USD)金额(美元): <?= number_format($initial_investment) ?></td>
            <td> 
                <table class="">
                    <tr>
                        <?php 
        ...
        <tr>
            <td class="cl-35">Processing Fee (汇款/支票号码) : USD 0.00</td>
            <td>Remitting/Issuing Bank(汇款/开证银行): <?= $subscription->remittance_bank ?></td>
        </tr>
        <tr>
            <td class="cl-35">Subscription Fee (%) (费用-%): <?= number_format($subscription->service_charge) ?></td>
            <td>Total Amount (USD) (金额-美元): 
    ...
    <table width="100%" class="page7 fo-rm">
        ...
        <tr>
            <td>Position (职位): <?= $subscription->position1 ?></td>
            <td>Position (职位): <?= $subscription->position2 ?></td>
            <td></td>
        </tr>
        <tr>
            <td>Date (日期): <?= date('d-m-Y', strtotime($subscription->created_at)); ?></td>
            <td>Date (日期): <?= date('d-m-Y', strtotime($subscription->created_at)); ?></td>
            <td></td>
        </tr>
    </table>
    ...
    <h1 class="t-c font-22">MCIL INTL SERIES 3 LTD (Company No. LL17539)<br><p class="t-c font-16">(A private fund company incorporated in the Federal Territory of Labuan, Malaysia)</p></h1>
    ...
    <p class="font-18" style="width: 100%;">That, I/We (本人/我们) <span class="underline_text"><?= $subscription->user->last_name; ?> </span></p>
    ...
    <p class="font-18">( &nbsp;&nbsp; &nbsp;&nbsp;) &nbsp;&nbsp; Personal Saving / Salary (个人储蓄/工资)</p>
    <p class="font-18">( &nbsp;&nbsp;&nbsp;&nbsp;) &nbsp;&nbsp; Business Income (营业收入)</p>
    <p class="font-18">( &nbsp;&nbsp;&nbsp;&nbsp;) &nbsp;&nbsp; Dividends from other entry (来自其他投资项目的股息)</p>
    <p class="font-18">( &nbsp;&nbsp;&nbsp;&nbsp;) &nbsp;&nbsp; Benefits of transactions due to me all of which are known to me. (应付给我的交易收益而所有这些交易 都是我 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;所知道)</p>
    ...
    <table width="100%">
        <tbody>
            <tr>
                ...
                <td width="30%"></td>
                <td><p class="font-18"> Name(姓名): <?= strtoupper($user->last_name); ?></p></td>
            </tr>
            <tr>
...
<!-- page 9 -->
    ...
    <p class="l-s font-18">Investor or applicant of MCIL INTL SERIES 3 LTD should complete this form. Our company is not responsible or liasee for any subsequent non-disclosure of your latest information. Contact us by email of ccs@mcilintl    .com.</p>
    ...
    <table class="table fo-rm" style="width:100%;margin-bottom: 30px">
        ...
        <tr>
            ...
            <td class="font-15"> <?= $subscription->user->last_name;?></td>
        </tr>
        <tr>
    ...
    <table  class="table fo-rm" style="width:100%;margin-bottom: 10px">
        ...
        <tr>
            ...
            <td class="font-15">
                <?php 
                    ...
                    echo "&nbsp;";
                    echo $subscription->has('SubscriptionTrState') ? $subscription->SubscriptionTrState->name : '';
                    echo "&nbsp;";
                ?>
        ...
        <tr>
            ...
            <td class="font-15">
                <?php 
                    echo $subscription->has('SubscriptionTrCountry') ? $subscription->SubscriptionTrCountry->name : ''; 
                ?>
    ...
    <table class="page11">
        ...
        <tr>
            ...
            <td height="60" width="35%"><?= $subscription->has('SubscriptionTd1Country') ? $subscription->SubscriptionTd1Country->name : '' ?></td>
    ...
    <p class="font-18">I understand that the information supplied by me is covered by the full provisions of the terms and conditions governing the Account Holder’s relationship with MCIL INTL SERIES 3 LTD setting out how MCIL INTL SERIES 3 LTD may use and share the information supplied by me.</p>
    ...
    <p class="font-18">I certify that where I have provided information regarding any other person (such as a Controlling Person or other Reportable Person to which this form relates) that I will, within 30 days of signing this form, notify those persons that I have provided such information to MCIL INTL SERIES 3 LTD and that such information may be provided to the tax authorities of the country/jurisdiction in which the account(s) is/are maintained and exchanged with tax authorities of another country(ies)/jurisdiction(s) in which the person may be tax resident pursuant to intergovernmental agreements to exchange financial account information.</p>

    <p class="font-18">I declare that all information made in this form are, to the best of my knowledge and belief, correct and complete. I undertake to advise MCIL INTL SERIES 3 LTD Limited within 30 days of any change in circumstances which affects the tax residency status of the individual identified in Part 1 of this form or causes the information contained herein to become incorrect, and to provide MCIL INTL SERIES 3 LTD Limited with a suitably updated self-certification and Declaration within 90 days of such change in circumstances.</p>
    ...
    <table width="100" class="table" style="padding: 20px;">
        <tbody>
            ...
            <tr>
                ...
                <td height="30" class="font-18"><?= strtoupper($subscription->user->last_name); ?></td>
            </tr>
            <tr>
...
<!-- page 13 -->
    ...
    <table class="page14">
        <tbody>
            <tr>
                ...
                <td colspan="2" class="font-15" height="20px;"></td>
            </tr>
            <tr>
                <td colspan="2" class="font-15" height="20px;"></td>
            </tr>
    ...
    <table class="page14">
        ...
        <tr>
            <td height="40"><?= strtoupper($user->last_name); ?></td>
            <td height="40"><u></u></td>
            <td height="40"></td> 
        </tr>
        </tbody>
