...
<body>
    <div class="main_div">
		...
		<table width="100%">
            <tr>
                <td><h4>NAME : <?= $user->first_name ?>
                    <?php 
                        if($subscription->is_joint_applicant == 1){ 
                            echo " & ".$subscription->ja_name; 
                        } 
                    ?></h4></td>
            </tr>
            <tr>
        ...
        <br><br>
		<h4 style="padding: 3px;">Dear : <?= $user->first_name ?>
                    <?php 
                        if($subscription->is_joint_applicant == 1){ 
                            echo " & ".$subscription->ja_name; 
                        } 
        ...
        <h4 style="padding: 3px;"><u><strong>RE: RENEWAL NOTICE OF THE SUBSCRIPTION IN MCIL3 FUND</strong></u></h4>
        <br>
