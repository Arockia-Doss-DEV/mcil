...
<body>
    <div class="main_div">
        ...
        <p>We hereby confirmed that you have chosen to reinvest your Investment ID : <?= $old_investment_no; ?>, and the request was submitted via the CRM, the investors' portal.</p>
