...
<body>
    <div class="main_div">
		...
		<table  width="100%">
            ...
            <tr>
                <td><h4>NAME</h4></td> 
                <td colspan="3"><h4><?= $user->last_name ?></h4></td>
            </tr>
            <tr>
                <td><h4>Address</h4></td>
		...
		<p>Special dividen bonus may be declared after the completion of the audit of thefund's yearly financial year end in December, subject to the availability of distributed income and the absolute discretion of the Board of Directors.</p>
