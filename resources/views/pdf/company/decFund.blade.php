...
<body>
	<h1 class="t-c font-22">MCIL INTERNATIONAL LIMITED (Company No. LL14041)</h1>
    ...
    <p class="font-18">Signature(签字) : <u>________________________________</u>  Name(姓名): <?= strtoupper($user->last_name); ?></p>
