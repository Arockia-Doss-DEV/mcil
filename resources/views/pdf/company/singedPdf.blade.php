	...
	<table width="100%">
	    <tbody>
	        <tr>
	            ...
	            <td width="30%"></td>
	            <td><p class="font-18"> Name(姓名): <?= strtoupper($subscription->user->last_name); ?></p></td>
	        </tr>
	        <tr>
...
<!-- page 13 -->
	...
	<table class="page14">
	    ...
	    <tr>
	        <td height="40"><?= strtoupper($subscription->user->last_name); ?></td>
	        <td height="40"><u></u></td>
	        <td height="40"></td> 
	    </tr>
		</tbody>
