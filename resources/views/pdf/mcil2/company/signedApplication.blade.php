...
<body>
    ...
    <table>
        <tbody align="center">
            ...
            <tr><td><p style="font-size: 30px;">MCIL INTL SERIES 2 LTD</p></td></tr>
            <tr><td><p style="font-size: 20px;">(Company No. LL17226)</p></td></tr>
    ...
    <table class="table">
        <tr>
            ...
            <td>
                <?php
                    echo '<p style="font-size:17px;">QuantumScalp Ltd.<br>
                        Fund Manager of MCIL INTL Series 2 Ltd<br>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <ol>
                        <li>Minimum initial investment amount shall be USD70,000.00 or any amount equal or more than Ringgit Malaysia Two Hundred Fifty Thousand (RM250,000.00) (首次投资，最低金额为70,000.00美元 或任何等于或超过马币二十五万令吉(RM250,000.00)。)</li>
                    ...
                    <ol start="5">
                        <li>Unless otherwise instructed / informed by the company, all cheques, bank drafts or cashiers/money orders must be made payable to "<b>MCIL INTL SERIES 2 LTD</b>" and crossed "<b>ACCOUNT PAYEE ONLY</b>". Please write your name/company's name, NRIC/Passport number/Certificate of Incorporation number on the back of all cheques, bank drafts or cashier's orders/ money orders.<br>(除非公司另有指示/通知,支票、银行汇票或银行本票抬头请写“<b>MCIL INTL SERIES 2 LTD</b>”, 并且在支票左上角画两条平行线，写上“<b>ACCOUNT PAYEE ONLY</b>”只限存入抬头人账户）。请在支票、银行汇票或银行本票背面注明你的姓名或公司名称；身份证号码或护照号码或公司成立登记证号码。</li>
                ...
                <td>
                    ...
                    <ul>
                        ...
                        <li><p>Please e-mail the form to us at admin@mcilintl.com or post it tous at: <b>MCIL INTL SERIES 2 LTD</b>, Address: <?php if($subscription->old_address == 1){ echo 'Unit 3A-2, Level 3A, Labuan Times Square, Jalan Merdeka, 87000 W.P. Labuan, Malaysia.'; }else{ echo 'Unit Level 14(B) &amp; 14(C), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 F.T. Labuan, Malaysia</p>'; } ?>.<br>(请通过电子邮件将申请书发送至 admin@mcilintl.com 或将申请书邮寄至： F.T.Labuan, Malaysia.) <b>MCIL INTL SERIES 2 LTD</b>，地址：<?php if($subscription->old_address == 1){ echo 'Unit 3A-2, Level 3A, Labuan Times Square, Jalan Merdeka, 87000 W.P. Labuan, Malaysia.'; }else{ echo 'Unit Level 14(B) &amp; 14(C), Main Office Tower, Financial Park Labuan, Jalan Merdeka, 87000 F.T. Labuan, Malaysia</p>'; } ?></p></li>
                    </ul>
    ...
    <h1 class="t-c font-22">MCIL INTL SERIES 2 LTD (Company No. LL17226)<br><p class="t-c font-16">(A private fund company incorporated in the Federal Territory of Labuan, Malaysia)</p></h1>
...
<!-- page 9 -->
    ...
    <p class="l-s font-18">Investor or applicant of MCIL INTL SERIES 2 LTD should complete this form. Our company is not responsible or liasee for any subsequent non-disclosure of your latest information. Contact us by email of ccs@mcilintl    .com.</p>
    ...
    <p class="font-18">I understand that the information supplied by me is covered by the full provisions of the terms and conditions governing the Account Holder’s relationship with MCIL INTL SERIES 2 LTD setting out how MCIL INTL SERIES 2 LTD may use and share the information supplied by me.</p>
    ...
    <p class="font-18">I certify that where I have provided information regarding any other person (such as a Controlling Person or other Reportable Person to which this form relates) that I will, within 30 days of signing this form, notify those persons that I have provided such information to MCIL INTL SERIES 2 LTD and that such information may be provided to the tax authorities of the country/jurisdiction in which the account(s) is/are maintained and exchanged with tax authorities of another country(ies)/jurisdiction(s) in which the person may be tax resident pursuant to intergovernmental agreements to exchange financial account information.</p>

    <p class="font-18">I declare that all information made in this form are, to the best of my knowledge and belief, correct and complete. I undertake to advise MCIL INTL SERIES 2 LTD Limited within 30 days of any change in circumstances which affects the tax residency status of the individual identified in Part 1 of this form or causes the information contained herein to become incorrect, and to provide MCIL INTL SERIES 2 LTD Limited with a suitably updated self-certification and Declaration within 90 days of such change in circumstances.</p>
