...
<body>
    <div class="main_div">
        ...
        <br>
        <h4><u><strong>Declaration of Dividend Distribution for MCIL INTL Series 2 Ltd (“the Fund”)</strong></u></h4>

        <p>Greetings from MCIL Intl Series 2 Ltd!</p>

        <p>Thank you for investing in MCIL Intl Series 2 Ltd (“the Fund”). We are pleased to announce the Fund’s dividend distribution declaration as follows:</p>
