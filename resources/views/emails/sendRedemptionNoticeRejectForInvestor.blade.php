					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
							    ...
							    <p>We regret to inform that your redemption request has been rejected due to one of the following reasons: </p>
							    <br>
							    {{ $data->redemption_msg }}
                                <br>
                                <p>Please contact the MCIL admin for any further clarifications.</p>
