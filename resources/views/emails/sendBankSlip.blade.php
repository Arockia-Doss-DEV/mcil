					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
                                ...
                                <p>The {{ $data->name }} with Investment ID : {{ $data->investment_id }} had uploaded the bank in slip for his/her investment.</p>
                                
                                <p>Kindly take note to check the bank in slip from admin portal and monitor the payment to be transferred into MCIL bank account.</p>
