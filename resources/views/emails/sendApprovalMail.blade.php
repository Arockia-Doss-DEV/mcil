					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
                                ...
                                <p>Kindly log in to the investment portal at <a href="{{ $user->link }}" target="_blank">{{ $user->link }}</a>. The banking instruction details is available for download on My Investment Details page. Once you have transferred your funds from your bank, please upload the wire transfer slip/details as proof of funding in the portal.</p>
