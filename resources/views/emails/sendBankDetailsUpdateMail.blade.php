					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
                                ...
                                <p>We have updated the beneficiary bank account details for your investment ID {{ $data->investment_no }}. Please contact the MCIL admin for any further support.</p>
