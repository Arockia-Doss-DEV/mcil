					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
							    ...
							    <p>Your redemption request for the investment ID {{ $data->investment_no }} has been received.We will process accordingly and inform you once completed. If you did not make this request, please contact the MCIL admin at admin@mcilintl.com</p>
