					...
					<tr>
						<td class="bg_white email-section">
							...
							<div class="heading-section" style=" padding: 0 30px;">
							    ...
							    <p>We are glad to confirm that your redemption request for the investment ID {{ $data->investment_no }} has been approved. Please contact the MCIL admin for any further support. </p>
