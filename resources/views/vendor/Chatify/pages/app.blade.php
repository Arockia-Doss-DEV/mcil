...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">Contact Support </span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                {{-- items --}}
                <p style="text-align: center;color:grey;margin-top:30px">Soon will be available</p>
             </div>
