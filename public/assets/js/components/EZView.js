...
$.fn.EZView = function(){
    var self    = this,
        ...
        index   = 0,
        icons   = {
            'eznext'     : base_url+'assets/images/media/right-arrow.png',
            'ezback'     : base_url+'assets/images/media/left-arrow.png',
            'download' : base_url+'assets/images/media/download-file.png',
            'zoomin'   : base_url+'assets/images/media/zoom-in.png',
            'zoomout'  : base_url+'assets/images/media/zoom-out.png',
            'ezclose'  : base_url+'assets/images/media/close.png',
        };
